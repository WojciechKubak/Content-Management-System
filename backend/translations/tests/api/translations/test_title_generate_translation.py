...
def test_api_response_on_failed_due_to_missing_translation(client) -> None:
    url = url_for("translations.title_generate_translation", translation_id=999)
...
def test_api_response_on_failed_due_to_not_pending_status_of_translation(
    ...
    url = url_for(
        "translations.title_generate_translation", translation_id=translation.id
    )
...
def test_api_response_on_success_returns_translated_title(client) -> None:
