...
class TestGetAllCategories:
    ...
    def test_when_no_categores(self, category_domain_service: CategoryService) -> None:
        result = category_domain_service.get_all_categories()
        assert not result

    def test_when_categories(self, category_domain_service: CategoryService) -> None:
