from articles.infrastructure.adapters.configuration import category_db_adapter, article_db_adapter, tag_db_adapter
...
domain_article_service = ArticleDomainService(article_db_adapter, category_db_adapter, tag_db_adapter)
