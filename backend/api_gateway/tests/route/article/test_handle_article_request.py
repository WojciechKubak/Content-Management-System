from gateway.route.article import handle_article_request
from unittest.mock import patch
from flask.testing import FlaskClient


class TestHandleArticleRequest:

    @patch('gateway.route.article.article_service.process_request')
    def test_handle_request_failure(self, mock_process_request, app: FlaskClient) -> None:
        ...
        with app.app_context():
            response = handle_article_request('GET', 'endpoint', {'key': 'value'})
